...
2. Make *properly formatted* README.md file in a subfolder called "JavaScriptReading" in your itp repository that outlines one thing you knew and one thing you did not know for each chapter of the reading (6 observations total) in complete sentences.
